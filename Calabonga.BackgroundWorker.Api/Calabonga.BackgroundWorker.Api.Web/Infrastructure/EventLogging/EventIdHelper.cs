...
namespace Calabonga.BackgroundWorker.Api.Web.Infrastructure.EventLogging
{
    ...
    static class EventIdHelper
    {
        ...
        public static readonly EventId StoppingReplanningId = new EventId(1008, "StoppingReplanning");
        ...
        public static readonly EventId WorkNotFoundId = new EventId(1012, "TotalReadyToStartWorksFoundForWorker");
