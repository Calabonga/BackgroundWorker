        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserProfileId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_ApplicationUserProfiles_ApplicationUserProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(nullable: true),
                    UpdatedBy = table.Column<string>(maxLength: 256, nullable: true),
                    ApplicationUserProfileId = table.Column<Guid>(nullable: false),
                    PolicyName = table.Column<string>(maxLength: 64, nullable: false),
                    Description = table.Column<string>(maxLength: 1024, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MicroservicePermissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MicroservicePermissions_ApplicationUserProfiles_ApplicationUserProfileId",
                        column: x => x.ApplicationUserProfileId,
                        principalTable: "ApplicationUserProfiles",
                        principalColumn: "Id",
